...
import  * as types from "../../actions/OrganisationSecteurs/OrganisationSecteursTypes";

const initialContactState ={
    listorganisationsecteur:[],
    organisation:{},
    loading:true,
};
const organisationsecteurReducers=(state=initialContactState, action)=>{
    switch(action.type) {
        case types.GET_ORGANISATIONSECTEURS:
            console.log("state gifs",state)
            return {
                ...state,
                listorganisationsecteur: action.payload,
                loading: false,
            }
        case types.DELETE_ORGANISATIONSECTEUR:
            return {
                ...state,
                loading: false,
            }
        case types.ADD_ORGANISATIONSECTEUR:
            return {
                ...state,
                loading: false,
            }
...
export default organisationsecteurReducers;