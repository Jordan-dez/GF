...
const EditableGf = ({editFormData, handleEditFormChange, handleCancelClick}) =>{
    return(
        <>
            <tr>
				<td></td>
                ...
                <td>
                    <input type="text" required = "required" placeholder = "numero du gf" name="num_gf" 
                        value={editFormData.num_gf}
                        onChange={handleEditFormChange}
                    />
                </td>
                <td>
                    <input type="text" required = "required" placeholder = "secteur" name="secteur" 
