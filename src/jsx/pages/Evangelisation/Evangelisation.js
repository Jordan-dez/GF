...
import { loadEvangelisation } from '../../../store/actions/Evangelisation/EvangelisationActions';
...
const Evangelisation = () =>{
    ...
    //selector
    const {evangelisations} = useSelector(state=>state.evangelisations)
	// delete data  
    ...
    console.log("evangelisation loaded",evangelisations)
	
	return(
		<>
			<PageTitle activeMenu="Table" motherMenu="Evangelisation" />
